...
| 11 | #18 Facility manager dashboard | AFK | Implementation complete; tests pass; PR pending | #10 and #17 complete | Main agent | `implementation/issue-18-dashboard-summary` | Pending | Pass / pending PR |
