...
| 4 | #11 Report detail and status history | AFK | Implementation complete; tests pass; PR pending | #8 and #9 complete | Main agent | `implementation/issue-11-report-detail-history` | Pending | Pending |
