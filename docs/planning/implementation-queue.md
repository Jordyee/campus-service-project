...
|---:|---|---|---|---|---|---|---|---|
| 1 | #8 Foundation data model, role boundary, lifecycle | HITL | Implemented; tests pass; draft PR pending | None | Main agent | `implementation/issue-8-foundation` | Pending | Pending |
