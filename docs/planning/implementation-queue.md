...
| 7 | #14 Technician assignment | AFK | Implementation complete; tests pass; PR pending | #13 complete | Main agent | `implementation/issue-14-technician-assignment` | Pending | Pending |
