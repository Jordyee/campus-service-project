...
| NFR-002 | US-001 to US-011 | Role-sensitive AC | SPEC-04, SPEC-05, INT-001, CR-003 | ARCH-COMP-004, ARCH-DEC-003, DB-01, API-04 to API-14, UI-01, UI-ACT-01 to UI-ACT-13 | #8, #10, #12, #13, #14, #15, #16, #17, #18, #19 | `worker/foundation.ts`, `worker/requests.ts`, `migrations/0001_foundation.sql`, `public/index.html` | `tests/unit/foundation.spec.ts`, `tests/integration/foundation-schema.spec.ts`, `tests/integration/list-requests-api.spec.ts`, `tests/integration/comments-api.spec.ts`, `tests/integration/admin-review-api.spec.ts`, `tests/integration/technician-assignment-api.spec.ts`, `tests/integration/technician-tasks-api.spec.ts`, `tests/integration/technician-work-status-api.spec.ts`, `tests/integration/admin-close-reopen-api.spec.ts`, `tests/integration/dashboard-summary-api.spec.ts` | Implemented through #18 for current role-sensitive flows; final traceability pass completed in #19 |
