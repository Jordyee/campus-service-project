...
|---|---|---|---|---|---|---|---|---|---|
| FR-001 | US-001 | AC-001, AC-002 | BR-002 | SPEC-04, SPEC-05 | ARCH-COMP-001, ARCH-COMP-002, ARCH-COMP-003, ARCH-FLOW-001, DB-02, DB-04, API-01, UI-02, UI-FORM-01, UI-ACT-01 | #8, #9, #19 | Foundation: `migrations/0001_foundation.sql`, `worker/foundation.ts`, `worker/status-history.ts` | `tests/unit/foundation.spec.ts`, `tests/integration/foundation-schema.spec.ts` | Foundation implemented; create flow pending #9 |
| FR-002 | US-001 | AC-001, AC-002 | BR-002 | INT-001 | ARCH-COMP-001, ARCH-COMP-002, ARCH-COMP-003, ARCH-FLOW-001, DB-01, DB-02, API-01, UI-02, UI-FORM-01 | #8, #9, #19 | Foundation: `migrations/0001_foundation.sql`, `worker/foundation.ts` | `tests/unit/foundation.spec.ts`, `tests/integration/foundation-schema.spec.ts` | Foundation implemented; create flow pending #9 |
